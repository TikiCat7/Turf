...
export default function TeamCreationFormWrapper() {
  const user = useUser()
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="container flex-col flex items-center justify-center space-y-2"
      >
        <div className="container max-w-lg space-y-4 py-2 pb-4">
          <FormField
            control={form.control}
            name="teamName"
            render={({ field }) => (
              ...
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="youth club 6-12">Youth 6-12</SelectItem>
